// Описание:
// Класс Market реализует методы интерфейсов
// QueueBehaviour и MarketBehaviour.
// Он имеет внутреннюю очередь (queue), которая имитирует
// очередь покупателей в магазине.
// Методы enqueue и dequeue реализуют добавление и удаление
// элементов из очереди соответственно.
// Методы enterMarket и exitMarket добавляют и удаляют
// покупателей из магазина.
// Метод update представляет
// собой обновление состояния магазина.
